...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sidebar.Models.Candidate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sidebar.Models.Certificate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sidebar.Models.Exam", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sidebar.Models.IdentityUsers.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Sidebar.Models.JointTables.CandidateExam", b =>
                {
            ...
            modelBuilder.Entity("Sidebar.Models.JointTables.ExamStem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sidebar.Models.Stem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Sidebar.Models.Topic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Sidebar.Models.IdentityUsers.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Sidebar.Models.Exam", b =>
                {
                    b.HasOne("Sidebar.Models.Candidate", "Candidate")
                        .WithMany()
                        .HasForeignKey("CandidateId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sidebar.Models.Certificate", "Certificate")
                        .WithMany("Exams")
            ...
            modelBuilder.Entity("Sidebar.Models.JointTables.CandidateExam", b =>
                {
                    ...
                    b.HasOne("Sidebar.Models.Exam", "Exam")
                        .WithMany()
            ...
            modelBuilder.Entity("Sidebar.Models.JointTables.ExamStem", b =>
                {
                    ...
                    b.HasOne("Sidebar.Models.Stem", "Stem")
                        .WithMany("ExamStems")
            ...
            modelBuilder.Entity("Sidebar.Models.Stem", b =>
                {
                    b.HasOne("Sidebar.Models.Topic", "Topic")
                        .WithMany("Stems")
